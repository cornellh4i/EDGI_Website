...
def starter_top_info():
    ...
    content = """
  Zoom in or search to select a county to see county-specific data on 
  violations, inspections, and enforcement actions by the EPA under the:
  - Clean Air Act (CAA)
  - Clean Water Act (CWA)
...
def gradingTabInfo():
    ...
    <div style="{gray_rectangle_style}">
        ...
        <ul>
            ...
            violating. Dividing violations by enforcements indicates the willingness
            to call fouls</li>
        </ul>
    </div>
    """
...
def highlightTabInfo():
    ...
    <div style="{gray_rectangle_style}">
        <ul>
            ...
            first 3 years of the Trump administration, there has been a <b>2% decrease 
            in inspections, 85% decrease in fines, and a 7% increase in enforcement actions.</b> </li>
            <li> Under the Clean Water Act, the law whose regulation is best documented 
            by available EPA data, <b> 759 facilities</b>, representing 44% of all regulated 
            facilities in [county name], were in violation for at least 9 months of the last 3 years. </li>
        </ul>
    </div>
    """
...
def comparisonTabInfo():
    ...
    <div style="{gray_rectangle_style}">
        <ul>
            <li>These two charts show how inspections and violations in this state 
            compare to the national average per 1000 facilities in 2022</li>
            <li>We use data from 2022 as it was the most recent full year and 
            the ECHO database only reports currently active facilities</li>
            <li>To enable comparison across locations with a differing number 
            of active facilities, we standardize the comparison to a value per 
            1000 facilities, proportionally adjusting the data if there are more 
            or less than 1000 facilities in a district or state</li>
        </ul>
    </div>
    """
...
def non_complianceTabInfo():
    ...
    <div style="{gray_rectangle_style}">
        <ul>
            <li>Noncompliance is ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
              Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
              nisi ut aliquip ex ea commodo consequat. Ut enim ad minim veniam, 
              quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
              commodo consequat.</li>
            <li>These figures show the ten facilities in this state with the 
            worst history of environmental compliance based on their number of 
            noncompliant quarters in the past 3 years (not necessarily consecutive). 
            Click on a facility name to view its ECHO report.</li>
        </ul>
    </div>
    """
